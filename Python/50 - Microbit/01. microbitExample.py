...
Save this program onto your microbit as 'main.py' and it will run automatically when reset
Use the physical reset button restart the program on the microbit
...
while True:
    if button_a.was_pressed(): # get the next multiple of the thirteen
        ...
        #print(f"Button a has been pressed {counter} times") # Warning: f strings won't work on the microbit :(
